...
#### 1.1.5 Decryption : the RFC-compliant depad, stated as an algorithm
...
#### 1.1.9 The plaintext-recovery game
...
### 1.2. The cryptographic attacker

#### 1.2.1 Warm-up: the distinguishing adversary
...
#### 1.2.4 The adversary $\mathcal{A}_{\mathrm{PR}}$
...
#### 1.2.5 Variants worth a remark each
...
#### 1.3.2 Lemma 2 (leakage separation) : the crux
...
#### 1.3.3 Lemma 3 (reduction to a padding oracle)
...
#### 1.3.4 Lemmas 4 and 5 (phase correctness) and Theorem 2
...
#### 1.3.5 Theorem 3 (the noisy model) : optional but the honest version
...
#### 1.3.6 Proposition (the leakage model is necessary, not convenient)
...
#### 1.3.7 Scope, stated as limitations
